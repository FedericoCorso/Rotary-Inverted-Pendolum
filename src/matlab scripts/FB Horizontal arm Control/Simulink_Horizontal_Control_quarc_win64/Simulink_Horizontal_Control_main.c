...
typedef RT_MODEL_Simulink_Horizontal__T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Simulink_Horizontal_Control(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Simulink_Horizontal_Control_initialize();
   extern void Simulink_Horizontal_Control_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, Simulink_Horizontal_Control_M->Timing.t[0]);
  }

  if (rtmIsMajorTimeStep(Simulink_Horizontal_Control_M)) {/* Sample time: [0.002s, 0.0s] */
    rtExtModeUpload(1, (((Simulink_Horizontal_Control_M->Timing.clockTick1+
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Simulink_Horizontal_Control_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  Simulink_Horizontal_Control_step();
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(Simulink_Horizontal_Control_DW.Encoders_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Simulink_Horizontal_Control:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Simulink_Horizontal_Control -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Simulink_Horizontal_Control_initialize();
  S = Simulink_Horizontal_Control_M;
  ...
  if (rtExtModeQuarcStartup(rtmGetRTWExtModeInfo(S),
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      fflush(stdout);
      result = hil_task_start(Simulink_Horizontal_Control_DW.Encoders_Task,
        (t_clock) Simulink_Horizontal_Control_P.Encoders_clock, 500.0, -1)
        ;
      if (result == 0) {
  ...
  Simulink_Horizontal_Control_terminate();
