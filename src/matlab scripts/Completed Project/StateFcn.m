function x = StateFcn(x,V_m)

th = [0.000392602899306717; 0.00210449418030595; 0.000100272212238932; 0.000750089811121891; 
        0.0292344187666263; 0.127000000000000; 0.216000000000000; 9.81000000000000; 70; 2.38337008027780;
        0.933935334310320; 0.707746266927856; 0.00845864677078897; 0.00739862697381762];

Ts = 0.002; % sampling time
x = x + Ts*NL_eqns_EKF(x,V_m,th);
end

function x_dot = NL_eqns_EKF(x,V_m,th)
%NL_eqns
